...
export function BottomNav() {
  return (
    <nav data-tour="nav-principal" className="glass-panel fixed inset-x-0 bottom-0 z-30 border-t border-border pb-[var(--sa-bottom)] shadow-[0_-4px_24px_-8px_rgba(0,0,0,0.18)]">
